...
//            .then(res => navigate.push('/'))
            ...
            .catch( err => window.alert("el usuario ya existe"));
    }
        ...
        <div className="row">
            <div className="col-6">
                ...
                <form onSubmit={registro}>
                    ...
                    <input type="submit" value="Registarme" style={{ backgroundColor:'#2F9FAD',color: 'white', margin: '10px', border: 'none', borderRadius:'50px'}}  />
                </form>
            </div>
            <div className="col-6">
                ...
                <form onSubmit={login}>
                    ...
                    <input type="submit" value="Iniciar Sesión" style={{ backgroundColor:'#2F9FAD',color: 'white', margin: '10px', border: 'none', borderRadius:'50px'}} />
                </form>
            </div>
        </div>
    )
